<template>
    <div class="wrap">   
        ...
        <layout-subject title="驾驶证扣分查询" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                stepData: ["01 驾驶证登入","02 交通违法查询"],
                active:0,
                pathArrs: ['marksLogin','marksCheack'],
                pathName:"jiaotongfa/deductMarksCommon" 
            }
        },
        computed:{
            pathArr(){
