<template>
    <div class="wrap">   
        ...
        <layout-subject title="机动车驾驶证达到规定年龄换证" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                stepData: ["01 事项窗口","02 资料提交","03 缴费", "04 完成"],
                active:0,
                pathArrs: ['renewalAgeWindow','renewalAgeSub','renewalAgeFees','renewalAgeSucceed'],
                pathName:"jiaotongfa/renewalAgeCommon" 
            }
        },
        computed:{
            pathArr(){
