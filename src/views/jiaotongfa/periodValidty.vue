<template>
    <div class="wrap">  
        ...
        <layout-subject title="机动车驾驶证有效期满换证" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                stepData: ["01 认证身份","02 资料提交","03 缴费", "04 完成"],
                active:0,
                pathArrs: ['validtyCheck','validtySub','validtyFees','validtySucceed'],
                pathName:"jiaotongfa/validtyCommon" 
            }
        },
        computed:{
            pathArr(){
