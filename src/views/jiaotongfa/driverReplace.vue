<template>
    <div class="wrap">   
        ...
        <layout-subject title="机动车驾驶证遗失补办" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                stepData: ["01 驾驶证登入","02 资料提交","03 缴费","04 完成"],
                active:0,
                pathArrs: ['replaceCheck','replaceSub','replaceFees','replaceSucceed'],
                pathName:"jiaotongfa/driverReplaceCommon" 
            }
        },
        computed:{
            pathArr(){
