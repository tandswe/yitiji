...
<script>
    ...
    canReuse: false,
        ...
        data() {
            return {
                stepData: ["01 身份证扫描","02 输入准考证号","03 查询成绩","04 完成"],
                active:0,
                pathArrs: ['scoreIdScan','admissionTicket','scoreQuery','scoreFinish'],
                pathName:"education/scoreInquiry",
                printopen:0 ,//是否打印
                btns:[
                    {
                        id:1,
