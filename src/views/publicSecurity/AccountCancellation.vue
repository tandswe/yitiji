<template>
    <div class="wrap">   
        ...
        <layout-subject title="户口注销证明" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
    ...
    export default {
        ...
        data() {
            return {
                ...
                active:0,
                pathArrs: ['accountWindow','accountSubmit','accountSucceed'],
                pathName:"AccountCancellation"
            }
        },
        computed:{
            pathArr(){
