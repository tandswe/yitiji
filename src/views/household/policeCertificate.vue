<template>
    <div class="wrap">  
        ...
        <layout-subject title="养老保险领取资格证" :stepDatas="stepData" :paths="pathArr"  ></layout-subject>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                stepData: ["01 事项窗口","02 资料提交","03 完成"],
                active:0,
                pathArrs: ['policeCertificateWindow','policeCertificateData','policeCertificateSucceed'],
                pathName:"policeCertificate" 
            }
        },
        computed:{
            pathArr(){
